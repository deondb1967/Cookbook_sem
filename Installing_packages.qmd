...
install.packages("lavaan.mi" , repos = "https://cloud.r-project.org/")
...
Some packages are hosted on Github, which is a site for developers. To download from Github we must first activate the `devtools` package. You may be asked if you want to update some packages. Choose "All".
