...
## You can go to the actual Github page of the package (https://github.com/xmc2/FAtools) and scroll down to the "Read me". Package developers will usually have download instructions in this section, which you can copy and paste in an Rstudio script window.
```
